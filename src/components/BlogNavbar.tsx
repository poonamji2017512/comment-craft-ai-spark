          ...
          <div className="flex items-center justify-between mx-[43px]">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <button onClick={() => navigate('/blog')} className="text-sm text-foreground font-medium">
                  Blog
                </button>
                <button onClick={() => scrollToSection('why-choose-interact')} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Why Choose Interact
                </button>
