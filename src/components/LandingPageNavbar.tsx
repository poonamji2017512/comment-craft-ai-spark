        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-border">
              ...
              <a href="#about" className="text-foreground hover:text-primary block px-3 py-2 rounded-md text-base font-medium transition-colors">
                About
              </a>
              ...
              {user ? (
                <div className="border-t border-border pt-4">
                  <a href="/dashboard" className="text-foreground hover:text-primary block px-3 py-2 rounded-md text-base font-medium transition-colors">
                    Dashboard
                  </a>
                  <Button variant="outline" onClick={handleAuthAction} className="w-full mt-2">
                    Sign Out
                  </Button>
                </div>
              ) : (
